...
lemma babybear_div_pow_5' [Fact (2013265921).Prime] (x: ZMod 2013265921) :
  x * 1950351361 = x / 2 ^ 5
:= by grind

lemma babybear_div_pow_5 [Fact BabyBear_Prime.Prime] (x: ZMod BabyBear_Prime) :
  x * 1950351361 = x / 2 ^ 5
:= by convert babybear_div_pow_5' x

lemma babybear_div_pow_6' [Fact (2013265921).Prime] (x: ZMod 2013265921) :
  x * 1981808641 = x / 2 ^ 6
:= by grind

lemma babybear_div_pow_6 [Fact BabyBear_Prime.Prime] (x: ZMod BabyBear_Prime) :
  x * 1981808641 = x / 2 ^ 6
:= by convert babybear_div_pow_6' x

lemma babybear_div_pow_7' [Fact (2013265921).Prime] (x: ZMod 2013265921) :
  x * 1997537281 = x / 2 ^ 7
:= by grind

lemma babybear_div_pow_7 [Fact BabyBear_Prime.Prime] (x: ZMod BabyBear_Prime) :
  x * 1997537281 = x / 2 ^ 7
...
lemma babybear_div_pow_9' [Fact (2013265921).Prime] (x: ZMod 2013265921) :
  x * 2009333761 = x / 2 ^ 9
:= by grind

lemma babybear_div_pow_9 [Fact BabyBear_Prime.Prime] (x: ZMod BabyBear_Prime) :
  x * 2009333761 = x / 2 ^ 9
