...
lemma add_partial_round_constants_equiv
  ...
  [Fact P.Prime]
:
  ((Array.ofFn fin_state).modify 0 fun x ↦ x + Poseidon2W24S11.Folding.partial_round_constants partial_round) =
  Array.ofFn (Poseidon2W24S11.Folding.add_partial_round_constant fin_state partial_round)
:= by
  apply Array.toList_inj.mp
  simp [Poseidon2W24S11.Folding.add_partial_round_constant]
...
:
  ...
  Array.ofFn (Poseidon2W24S11.Folding.apply_partial_round_sbox fin_state)
:= by
  apply Array.toList_inj.mp
  simp [Poseidon.HashProfile.sBox, Poseidon2W24S11.Folding.apply_partial_round_sbox]
  ...
  =
    ⟨
      ...
      ⟨
        ...
        Array.ofFn (Poseidon2W24S11.Folding.partial_round fin_state partial_round)
      ⟩
    ⟩
:= by
  simp [
