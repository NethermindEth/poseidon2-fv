...
:
  ...
  =
    ⟨
      PUnit.unit,
      ⟨start_round, Array.ofFn (Poseidon2W16S7.Folding.generic_internal_linear_layer fin_state)⟩
    ⟩
:= by
  ...
  split_ands
  all_goals simp [
    Poseidon2W16S7.Folding.generic_internal_linear_layer,
    Poseidon2W16S7.Folding.internal_layer_mat_mul,
    ←add_assoc,
