...
lemma apply_m4_equiv_1
  ...
  (h_state3 : state (idx + 3) = x3)
:
  (Poseidon2Spec.smallMatrixAction #[x0, x1, x2, x3])[1]? =
  .some ↑(Poseidon2.Folding.apply_m4 state idx 1)
:= by
  simp [
    Poseidon2Spec.smallMatrixAction,
    Poseidon2.Folding.apply_m4,
...
lemma apply_m4_equiv_2
  ...
  (h_state3 : state (idx + 3) = x3)
:
  (Poseidon2Spec.smallMatrixAction #[x0, x1, x2, x3])[2]? =
  .some ↑(Poseidon2.Folding.apply_m4 state idx 2)
:= by
  simp [
    Poseidon2Spec.smallMatrixAction,
    Poseidon2.Folding.apply_m4,
...
lemma apply_m4_equiv_3
  ...
  (h_state3 : state (idx + 3) = x3)
:
  (Poseidon2Spec.smallMatrixAction #[x0, x1, x2, x3])[3]? =
  .some ↑(Poseidon2.Folding.apply_m4 state idx 3)
:= by
  simp [
    Poseidon2Spec.smallMatrixAction,
    Poseidon2.Folding.apply_m4,
